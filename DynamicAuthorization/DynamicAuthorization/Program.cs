...
var permissionList = new PermissionsList();
...
public class DynamicAuthorizationHandler : AuthorizationHandler<DynamicRequirement>
{
        ...
        DynamicRequirement requirement)
    {
        ...
        var database = (PermissionsDatabase)scope.ServiceProvider.GetRequiredService(typeof(PermissionsDatabase));
        foreach (var authTag in authTags)
        {
...
public class PermissionsList : List<string>
{
